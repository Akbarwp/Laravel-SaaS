        ...
        <Feature feature={feature} answer={answer}>
            <form onSubmit={submit} method='post' encType='multipart/form-data' className='p-8 grid grid-cols-2 gap-3'>
                <label className="form-control w-full">
                    ...
                    <input type="number" step='0.1' min='0' name='number1' placeholder="Number 1" className="input input-bordered w-full dark:text-slate-700" value={data.number1} onChange={(e) => setData('number1', e.target.value)} required />
                    <div className="label">
                ...
                <label className="form-control w-full">
                    ...
                    <input type="number" step='0.1' min='0' name='number2' placeholder="Number 2" className="input input-bordered w-full dark:text-slate-700" value={data.number2} onChange={(e) => setData('number2', e.target.value)} required />
                    <div className="label">
